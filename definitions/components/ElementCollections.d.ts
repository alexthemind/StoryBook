declare const actionTabs: (parent: HTMLElement) => void;
...
export { buildUiList, textDarkBlock, shadeTextBlock, exampleBlockContent, implementScrollUp, activeSearchInput, actionTabs };
